 ...
 * @author Oskar Moritz
 * @version 2.0 
 * Die Klasse "Client" regelt client-seitig die Art der Verbindung. F�r eine Verbindung werden sowohl das UDP als auch das TCP portocol ben�tigt.
 * Hier werden dasw UDP und das TCP protcol zusammengef�hrt.
 */
public class Client extends Thread{
  ...
  public void run() {
    ...
    listener3.start();
    while ( true ){
      //zus�tzlich sendet der CLient durch diese "while(true)" schleife alle 100ms eigene Packete
      try {
        send();
      } catch (IOException e) {
        e.printStackTrace();
