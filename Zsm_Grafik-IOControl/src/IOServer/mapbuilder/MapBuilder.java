...
/**
 * @author Ruben Haag
 * Diese Klasse enth�lt Methoden um aus einem Bild Rechtecke(Plattformen) und Portale auszulesen.
 * Rechtecke werden durch ihre Rechteckige Form und ihre schwarze Farbe erkannt. W�rend Portale durch die Farbe Rot(255,0,0)
 * erkannt werden.
 */
public class MapBuilder {
    ...
    /**
     * Diese Methode gibt ein Portal, welches aus dem Bild erkannt wird zur�ck.
