...
public class Settings{
     ...
     */
    Settings(String pfad)throws FileNotFoundException, IOException{
        leseParams();
        this.pfad = pfad;
    }
     ...
     */
    public boolean leseParams() throws FileNotFoundException, IOException{
    ...
    /**
     * Diese Methode schreibt alle Einstellungen in die Speicherdatei.
     * @throws FileNotFoundException, wenn die Datei nicht gefunden, wenn die Datei nicht gefunden wied
     */
    public void writeParams() throws FileNotFoundException{
    ...
    public Settings setTastaurLinks(char tastaurLinks) {
        ...
        for(String i[]: ausgabe){
            if(i[0].equals("tastaurLinks")){
                i[1] = String.valueOf(tastaurLinks);
            }
        }
        return this;
    }
    ...
    public Settings setTastaurRechts(char tastaurRechts) {
        ...
        for(String i[]: ausgabe){
            if(i[0].equals("tastaurRechts")){
                i[1] = String.valueOf(tastaurRechts);
            }
        }
        return this;
    }
    ...
    public Settings setTastaurJump(char tastaurJump) {
        ...
        for(String i[]: ausgabe){
            if(i[0].equals("tastaurJump")){
                i[1] = String.valueOf(tastaurJump);
            }
        }
        return this;
    }
    ...
    public Settings setTastaurAttack1(char tastaurAttack1) {
        ...
        for(String i[]: ausgabe){
            if(i[0].equals("tastaurAttack1")){
                i[1] = String.valueOf(tastaurAttack1);
            }
        }
        return this;
    }
    ...
    public Settings setTastaurAttack2(char tastaurAttack2) {
        ...
        for(String i[]: ausgabe){
            if(i[0].equals("tastaurAttack2")){
                i[1] = String.valueOf(tastaurAttack2);
            }
        }
        return this;
    }
    ...
    public Settings setTastaurAttack3(char tastaurAttack3) {
        ...
        for(String i[]: ausgabe){
            if(i[0].equals("tastaurAttack3")){
                i[1] = String.valueOf(tastaurAttack3);
            }
        }
        return this;
    }
    ...
    public Settings setMausBenutzen(boolean mausBenutzen) {
        ...
        for(String i[]: ausgabe){
            if(i[0].equals("mausBenutzen")){
                i[1] = String.valueOf(mausBenutzen);
            }
        }
        return this;
    }
    ...
    public Settings setAufloesungX(int aufloesungX) {
        ...
        for(String i[]: ausgabe){
            if(i[0].equals("aufloesungX")){
                i[1] = String.valueOf(aufloesungX);
            }
        }
        return this;
    }
    ...
    public Settings setAufloesungY(int aufloesungY) {
        ...
        for(String i[]: ausgabe){
            if(i[0].equals("auflösungY")){
                i[1] = String.valueOf(aufloesungY);
            }
        }
