<<<<<<< HEAD:Zsm_Grafik-IOControl/src/IOServer/Player.java
...
public class PlayerIO {
    ...
    private int jumpheight = 100;
    private int movementspeed = 100;
    private Rectangle hb = new Rectangle(new PositionIO(400,400), 10, 20);
    private double health = 100;
    private double damage;
    //todo regspeed
    private double regSpeed;
    private double mana = 100;
    private boolean isJumping, isHitted, isAttacking, isLookingRight, isSprinting, isBoss, isDead;
    private Attack amNormal = new Attack(new Rectangle(new PositionIO(0,0), 10, 10), 0, 0, 0);
    private Attack amSpec1 = new Attack(new Rectangle(new PositionIO(0,0), 10, 10), 1, 0, 0);
    private Attack amSpec2 = new Attack(new Rectangle(new PositionIO(0,0), 10, 10), 2, 0, 0);
    private Rectangle gr =  new Rectangle(new PositionIO(0,0), 10, 10);

    public void setUpdateSSelf(PlayerIO p) {
        health = p.getHealth();
        damage = p.getDamage();
        mana = p.getMana();
        isDead = p.isDead();
    ...
    public void setUpdateSOther(PlayerIO p) {
        health = p.getHealth();
        damage = p.getDamage();
        mana = p.getMana();
        isDead = p.isDead();
...
>>>>>>> master:Zsm_Grafik-IOControl/src/IOServer/PlayerIO.java
